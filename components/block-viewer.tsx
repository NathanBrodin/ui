...
function BlockViewerToolbar() {
  ...
  const command = React.useMemo(() => {
    ...
    let pmCommand: string = packageManager
    ...
    return `${pmCommand} shadcn@latest add https://ui.brodin.dev/r/${item.name}.json`
    ...
    <div className="hidden group-data-[view=code]/block-view-wrapper:hidden md:h-(--height) lg:flex">
      <div className="relative grid w-full gap-4">
        ...
        <ResizablePanelGroup
          ...
          className="after:bg-card/50 relative z-10 after:absolute after:inset-0 after:right-3 after:z-0 after:rounded-xl"
        >
          <ResizablePanel
