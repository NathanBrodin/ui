...
export function ComponentPreviewTabs({
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center justify-between">
          {!hideCode && (
            <TabsList className="justify-start gap-4 rounded-none bg-transparent px-2 md:px-0">
              <TabsTrigger
                value="preview"
                className="text-muted-foreground data-[state=active]:text-primary px-0 text-base data-[state=active]:bg-transparent data-[state=active]:shadow-none dark:data-[state=active]:border-transparent"
              >
                Preview
              </TabsTrigger>
              <TabsTrigger
      ...
      <div
        data-tab={tab}
        className="data-[tab=code]:border-code bg-card relative rounded-lg border md:-mx-4"
      >
        <div
          data-slot="preview"
